    ...
    <div className="bg-brand-bg min-h-screen pt-20">
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <motion.div 
          ...
          className="mb-16 rounded-2xl bg-brand-dark p-8 md:p-16 text-center shadow-xl ring-1 ring-white/10"
        >
          <h2 className="text-3xl md:text-5xl font-extrabold mb-6 text-white tracking-tight">
            Security & Data Protection
          </h2>
          <p className="mx-auto max-w-3xl text-lg md:text-xl text-brand-surface/80 leading-relaxed">
